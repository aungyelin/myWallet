...
public enum TransactionDateFilter: Hashable, Sendable {
    ...
    public var localizedTitle: String {
        switch self {
        case .all:
            return String(localized: "filter_date_all", defaultValue: "All Time")
        case .today:
            return String(localized: "filter_date_today", defaultValue: "Today")
        case .last7Days:
            return String(localized: "filter_date_7days", defaultValue: "Last 7 Days")
        case .last30Days:
            return String(localized: "filter_date_30days", defaultValue: "Last 30 Days")
        case .custom:
            return String(localized: "filter_date_custom", defaultValue: "Custom Range")
        }
    }
